...
**Role** — это набор файлов, задач, шаблонов, переменных и обработчиков, которые объединены вместе в логическую структуру и служат определённой цели. Роли можно подключать в плейбуки. Роли удобно передавать коллегам, как целостную сущность
...
<details>
  <summary>Install Apache</summary>
...
<details>
  <summary>Apache and copy index.html</summary>
