...
99,99_
 Допустимое время простоя 26 минут в год
Четвёртый уровень надёжности требует
внушительных затрат:
 так как дублируются резервные инженерные
системы (основные и дополнительные)  
2(N + 1
 основные и резервные компоненты
разнесены по разным помещениям
